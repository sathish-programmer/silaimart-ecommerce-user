...
import { ShoppingCartIcon, UserIcon, Bars3Icon, XMarkIcon, HeartIcon, StarIcon, GiftIcon, TruckIcon } from '@heroicons/react/24/outline';
              ...
              {user ? (
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-gray-900 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                    ...
                    <Link to="/track-order" className="block px-4 py-2 text-white hover:bg-gray-800">Track Order</Link>
                    <Link to="/custom-order" className="block px-4 py-2 text-white hover:bg-gray-800">Custom Order</Link>
                    <Link to="/about" className="block px-4 py-2 text-white hover:bg-gray-800">About</Link>
                    <Link to="/support" className="block px-4 py-2 text-white hover:bg-gray-800">Support</Link>
                    <div className="border-t border-gray-700 my-1"></div>
          ...
          {isOpen && (
            <div className="md:hidden border-t border-gray-800">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <Link to="/track-order" onClick={() => setIsOpen(false)} className="block w-full text-left px-3 py-2 text-white hover:text-bronze flex items-center gap-2">
